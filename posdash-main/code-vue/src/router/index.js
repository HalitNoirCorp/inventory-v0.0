...
const Dashbord = () => import('@/views/backend/main/Dashbord1')
const Report = () => import('@/views/backend/main/report')

// //pages product
const listProduct = () => import('@/views/backend/product/listproduct')
const AddProduct = () => import('@/views/backend/product/addproduct')

// //pages Categories
const ListCategory = () => import('@/views/backend/Categories/listcategory')
const AddCategory = () => import('@/views/backend/Categories/addcategory')

// //pages Sale
const ListSale = () => import('@/views/backend/Sale/listsale')
const AddSale = () => import('@/views/backend/Sale/addsale')

// //pages Purchases
const ListPurchases = () => import('@/views/backend/Purchases/listpurchases')
const AddPurchase = () => import('@/views/backend/Purchases/addpurchase')

// //pages Returns
const ListReturns = () => import('@/views/backend/Returns/listreturns')
const AddReturn = () => import('@/views/backend/Returns/addreturn')

// //pages People
const Customers = () => import('@/views/backend/People/customers')
const AddCustomers = () => import('@/views/backend/People/addcustomers')
const Users = () => import('@/views/backend/People/users')
const AddUsers = () => import('@/views/backend/People/addusers')
const Suppliers = () => import('@/views/backend/People/suppliers')
const AddSuppliers = () => import('@/views/backend/People/addsuppliers')
...
const childRoute = () => [
  ...
  },
  {
    ...
    meta: {  name: 'product listproduct' },
    component: listProduct
  },
  {
    path: 'addproduct',
    name: 'product.addproduct',
    meta: {  name: 'product addproduct' },
    component: AddProduct
  },
  {
    path: 'listcategory',
    name: 'category.listcategory',
    meta: {  name: 'category listcategory' },
    component: ListCategory
  },
  {
    path: 'addcategory',
    name: 'category.addcategory',
    meta: {  name: 'category addcategory' },
    component: AddCategory
  },
  {
    path: 'listsale',
    name: 'sale.listsale',
    meta: {  name: 'sale listsale' },
    component: ListSale
  },
  {
    path: 'addsale',
    name: 'sale.addsale',
    meta: {  name: 'sale addsale' },
    component: AddSale
  },
  {
    path: 'listpurchases',
    name: 'purchase.listpurchases',
    meta: {  name: 'purchase listpurchases' },
    component: ListPurchases
  },
  {
    path: 'addpurchase',
    name: 'purchase.addpurchase',
    meta: {  name: 'purchase addpurchase' },
    component: AddPurchase
  },
  {
    path: 'listreturns',
    name: 'return.listreturns',
    meta: {  name: 'return listreturns' },
    component: ListReturns
  },
  {
    path: 'addreturn',
    name: 'return.addreturn',
    meta: {  name: 'Return addreturn' },
    component: AddReturn
  },
  {
    path: 'customers',
    name: 'people.customers',
    meta: {  name: 'people customers' },
    component: Customers
  },
  {
    path: 'addcustomers',
    name: 'people.addcustomers',
    meta: {  name: 'people addcustomers' },
    component: AddCustomers
  },
  {
    path: 'users',
    name: 'people.users',
    meta: {  name: 'people users' },
    component: Users
  },
  {
    path: 'addusers',
    name: 'people.addusers',
    meta: {  name: 'people addusers' },
    component: AddUsers
  },
  {
    path: 'suppliers',
    name: 'people.suppliers',
    meta: {  name: 'people suppliers' },
    component: Suppliers
  },
  {
    path: 'addsuppliers',
    name: 'people.addsuppliers',
    meta: {  name: 'people addsuppliers' },
    component: AddSuppliers
  },
  {
    path: 'report',
    name: 'layout.report',
    meta: {  name: 'layout report' },
    component: Report
  },
  {
    path: 'widget-simple',
