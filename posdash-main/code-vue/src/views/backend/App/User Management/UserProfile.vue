               ...
               <div class="card card-block card-stretch card-height">
                  <div class="card-body">
                     <tab-nav id="profile-pills-tab"  :pills="true" role="tablist" extraclass="d-flex nav nav-pills mb-3 text-center profile-tab">
                        <tab-nav-items id="myskills" :active="true" dataToggle="pill" ariaControls="profile1"  role="tab" :ariaSelected="true" title="My Skills" />
                         <tab-nav-items id="personalInfo" dataToggle="pill" ariaControls="profile2"  role="tab" :ariaSelected="false" title="Personal Information"  />
                        <tab-nav-items id="education" dataToggle="pill" ariaControls="profile3"  role="tab" :ariaSelected="false" title="Education" />
                        <tab-nav-items id="experience" dataToggle="pill" ariaControls="profile4"  role="tab" :ariaSelected="false" title="Experience" />
                        <tab-nav-items id="about" dataToggle="pill" ariaControls="profile5"  role="tab" :ariaSelected="false" title="About" />
                     </tab-nav>
                                       ...
                                       <div class="d-flex align-items-center pt-2">
                                          ...
                                          <div class="ml-3 w-100">
                                             ...
                                             <div class="iq-progress-bar mt-3">
                                                <Progressbar :value="85" color="primary" class="iq-progress progress-1" />
                                             </div>
                                          </div>
                                       </div>
                                    </li>
                                    <li class="mb-4">
                                       <div class="d-flex align-items-center pt-2">
                                          ...
                                          <div class="ml-3 w-100">
                                             ...
                                             <div class="iq-progress-bar mt-3">
                                                <Progressbar :value="85" color="danger" class="iq-progress progress-1" />
                                             </div>
                                          </div>
                                       </div>
                                    </li>
                                    <li>
                                       <div class="d-flex align-items-center pt-2">
                                          ...
                                          <div class="ml-3 w-100">
                                             ...
                                             <div class="iq-progress-bar mt-3">
                                                <Progressbar :value="85" color="warning" class="iq-progress progress-1" />
                                             </div>
                                          </div>
                                       </div>
                                    </li>
                                    ...
                                    <li class="mb-4">
                                       <div class="d-flex align-items-center pt-2">
                                          ...
                                          <div class="ml-3 w-100">
                                             ...
                                             <div class="iq-progress-bar mt-3">
                                                <Progressbar :value="85" color="success" class="iq-progress progress-1" />
                                             </div>
                                          </div>
                                       </div>
                                    </li>
                                    <li class="mb-4">
                                       <div class="d-flex align-items-center pt-2">
                                          ...
                                          <div class="ml-3 w-100">
                                             ...
                                             <div class="iq-progress-bar mt-3">
                                                <Progressbar :value="85" color="info" class="iq-progress progress-1" />
                                             </div>
                                          </div>
                                       </div>
                                    </li>
                                    <li>
                                       <div class="d-flex align-items-center pt-2">
                                          ...
                                          <div class="ml-3 w-100">
                                             ...
                                             <div class="iq-progress-bar mt-3">
                                                <Progressbar :value="85" color="secondary" class="iq-progress progress-1" />
                                             </div>
                                          </div>
                                       </div>
                                    </li>
