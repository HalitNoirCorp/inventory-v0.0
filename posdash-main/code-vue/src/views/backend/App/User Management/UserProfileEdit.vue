                  ...
                  <div class="card-body p-0">
                     <div class="iq-edit-list usr-edit">
                        <tab-nav :pills="true "   extraclass="iq-edit-profile d-flex" >
                           <tab-nav-items :active="true" id="personal" dataToggle="pill" ariaControls="personal-information"   title="Personal Information" liClass=" col-md-3 p-0" />
                           <tab-nav-items :active="false" id="chang" dataToggle="pill" ariaControls="chang-pwd"   title="Change Password" liClass=" col-md-3 p-0" />
                             <tab-nav-items :active="false" id="email" dataToggle="pill" ariaControls="emailandsms"   title=" Email and SMS" liClass=" col-md-3 p-0" />
