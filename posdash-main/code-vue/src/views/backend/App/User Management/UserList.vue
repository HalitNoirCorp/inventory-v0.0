                                 ...
                                 <tr>
                                    ...
                                    <td>
                                       <div class="flex align-items-center list-user-action">
                                          <a class="btn btn-sm bg-primary mr-1" v-b-tooltip.top title="Add" href="#"><i class="ri-user-add-line mr-0 "></i></a>
                                          <a class="btn btn-sm bg-primary mr-1" v-b-tooltip.top title="Edit"  href="#"><i class="ri-pencil-line mr-0 "></i></a>
                                          <a class="btn btn-sm bg-primary"  v-b-tooltip.top title="Delete"  href="#"><i class="ri-delete-bin-line mr-0 "></i></a>
                                       </div>
                                    </td>
                                 </tr>
                                 <tr>
